...
var author$project$Main$applicationSubTitle = 'lol';
...
var author$project$Main$Item = F2(
	function (slot, affixes) {
		return {affixes: affixes, slot: slot};
	});
var author$project$Main$initItem = function (slot) {
	return A2(author$project$Main$Item, slot, _List_Nil);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('modal-card-body modal1')
					]),
				_List_fromArray(
					[
						A2(
...
var author$project$Main$inputItemInModal = function (item) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							return author$project$Main$inputItemInModal(item);
						}()
						]))
				]));
	}
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Affix":{"args":[],"type":"{ value : Basics.Int, stat : Main.Stat }"},"Main.Hero":{"args":[],"type":"{ name : String.String, rarity : Basics.Int, element : String.String, stats : Main.Stats, skills : List.List Main.Skill }"},"Main.Item":{"args":[],"type":"{ slot : Main.Slot, affixes : List.List Main.Affix }"},"Main.Modifier":{"args":[],"type":"{ category : Maybe.Maybe Main.Stat, target : Maybe.Maybe Main.Origin, section : Main.Section, value : Basics.Float, soulburn : Basics.Float }"},"Main.Skill":{"args":[],"type":"{ isPassive : Basics.Bool, soulburn : Basics.Int, soulburnEffect : Maybe.Maybe String.String, cooldown : Basics.Int, name : String.String, description : Maybe.Maybe String.String, modifiers : List.List Main.Modifier }"},"Main.Stats":{"args":[],"type":"{ atk : Basics.Int, hp : Basics.Int, spd : Basics.Int, def : Basics.Int, chc : Basics.Float, chd : Basics.Float, eff : Basics.Float, efr : Basics.Float }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Loading":["String.String"],"GotHero":["Result.Result Http.Error Main.Hero"],"AddHeroButton":["Main.AddHeroButtonMsg"],"CloseModal":[],"HeroClicked":["String.String","Main.AddHeroButtonMsg"],"OpenModal":["Main.ModalMsg","Main.Item"]}},"Main.AddHeroButtonMsg":{"args":[],"tags":{"HideAddHeroDropdownMenu":[],"ShowAddHeroDropdownMenu":[]}},"Main.ModalMsg":{"args":[],"tags":{"OpenInput":[]}},"Main.Origin":{"args":[],"tags":{"Self":[],"Target":[]}},"Main.Section":{"args":[],"tags":{"Additive":[],"Multiplicative":[],"Pow":[]}},"Main.Slot":{"args":[],"tags":{"Weapon":[],"Helmet":[],"Armor":[],"Necklace":[],"Ring":[],"Boots":[],"Artifact":[]}},"Main.Stat":{"args":[],"tags":{"Atk":[],"AtkPercent":[],"HP":[],"HPPercent":[],"Def":[],"DefPercent":[],"ChC":[],"ChD":[],"Eff":[],"EfR":[],"Speed":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}}}}})}});}(this));