...
var author$project$Main$updateModal = F3(
	function (modalMsg, s, model) {
		return _Utils_update(
			model,
			{
				modal: elm$core$Maybe$Just(
					author$project$Main$InputItem(s))
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'OpenModal':
				...
				var s = msg.b;
				return _Utils_Tuple2(
					A3(author$project$Main$updateModal, modalMsg, s, model),
					elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(author$project$Main$OpenModal, author$project$Main$OpenInput, 'Schwert')),
											elm$html$Html$Attributes$src(imageurl)
										]),
									_List_Nil),
									A2(
...
var author$project$Main$inputItem = function (s) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				author$project$Main$modalHeader(s),
				A2(
				elm$html$Html$section,
				_List_fromArray(
					[
...
var author$project$Main$inputItemInModal = function (s) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							function () {
							var string = modalState.a;
							return author$project$Main$inputItemInModal(string);
						}()
						]))
				]));
	}
