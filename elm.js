...
var author$project$Main$initialModel = function (_n0) {
	return _Utils_Tuple2(
		{addHeroButton: author$project$Main$HideButtonMenu, hero: elm$core$Maybe$Nothing, imageURL: '', items: _List_Nil, name: '', simulatedStats: author$project$Main$initStats},
								...
								[
									...
									_List_fromArray(
										[
											...
											A2(author$project$Main$HeroClicked, '', author$project$Main$HideAddHeroDropdownMenu)),
											elm$html$Html$Attributes$src(imageurl)
										]),
									_List_Nil),
									A2(
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Hero":{"args":[],"type":"{ name : String.String, rarity : Basics.Int, element : String.String, stats : Main.Stats, skills : List.List Main.Skill }"},"Main.Modifier":{"args":[],"type":"{ category : Maybe.Maybe Main.Stat, target : Maybe.Maybe Main.Origin, section : Maybe.Maybe Main.Section, value : Basics.Float, soulburn : Basics.Float }"},"Main.Skill":{"args":[],"type":"{ isPassive : Basics.Bool, soulburn : Basics.Int, soulburnEffect : Maybe.Maybe String.String, cooldown : Basics.Int, name : String.String, description : Maybe.Maybe String.String, modifiers : List.List Main.Modifier }"},"Main.Stats":{"args":[],"type":"{ atk : Basics.Int, hp : Basics.Int, spd : Basics.Int, def : Basics.Int, chc : Basics.Float, chd : Basics.Float, eff : Basics.Float, efr : Basics.Float }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Loading":["String.String"],"GotHero":["Result.Result Http.Error Main.Hero"],"AddHeroButton":["Main.AddHeroButtonMsg"],"CloseModal":[],"HeroClicked":["String.String","Main.AddHeroButtonMsg"]}},"Main.AddHeroButtonMsg":{"args":[],"tags":{"HideAddHeroDropdownMenu":[],"ShowAddHeroDropdownMenu":[]}},"Main.Origin":{"args":[],"tags":{"Self":[],"Target":[]}},"Main.Section":{"args":[],"tags":{"Additive":[],"Multiplicative":[],"Pow":[]}},"Main.Stat":{"args":[],"tags":{"Atk":[],"AtkPercent":[],"HP":[],"HPPercent":[],"Def":[],"DefPercent":[],"ChC":[],"ChD":[],"Eff":[],"EfR":[],"Speed":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}}}}})}});}(this));